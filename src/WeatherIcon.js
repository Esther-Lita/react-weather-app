...
export default function WeatherIcon(props) {
  ...
  const codeMapping = {
    ...
    "11d": <Icon.CloudLightning color="#E8F9FD" size={size} />,
    "11n": <Icon.CloudLightning color="#E8F9FD" size={size} />,
    "13d": <Icon.CloudSnow color="#CAD3C8" size={size} />,
    "13n": <Icon.CloudSnow color="#CAD3C8" size={size} />,
